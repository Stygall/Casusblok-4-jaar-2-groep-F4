...
export declare type AuthType = "dot" | "polkadot" | "kusama" | "erd" | "elrond";
...
export declare type Login = (username: string, password: string, options?: LoginOptions) => Promise<void>;
export declare type Signup = (username: string, password: string, email?: string, otherFields?: SetUserData, options?: SignupOptions) => Promise<void>;
...
export declare const _useMoralisAuth: (options: UseMoralisAuthOptions) => {
    auth: Authentication;
    authenticate: ({ onComplete, onError, onSuccess, throwOnError, type, }?: AuthenticateOptions) => Promise<void>;
    signup: Signup;
    login: Login;
