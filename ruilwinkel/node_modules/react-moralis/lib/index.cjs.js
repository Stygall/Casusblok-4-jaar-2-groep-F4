...
var useMoralisCloudFunction = function (name, params, options) {
            ...
            return __generator(this, function (_c) {
                switch (_c.label) {
                    ...
                    case 1:
                        ...
                        return [4 /*yield*/, moralis.Moralis.Cloud.run(name, __assign(__assign({}, params), fetchParams))];
                    case 2:
                        results = _c.sent();
                        setData(results);
                        if (onSuccess) {
    ...
    var isLoading = isFetching && data == null;
    /**
            ...
            return __generator(this, function (_c) {
                switch (_c.label) {
                    case 0:
                        ...
                        setIsUploading(true);
                        setError(null);
                        moralisFile_1 = new moralis.Moralis.File(name, file, type, 
...
var defaultUseMoralisAuthOptions = {
...
var _useMoralisAuth = function (options) {
    var onAccountChanged = __assign(__assign({}, defaultUseMoralisAuthOptions), options).onAccountChanged;
    var setUser = options.setUser;
    var _a = react$1.useState(initialAuth), auth = _a[0], setAuth = _a[1];
    var _b = react$1.useState(false), hasOnAccountChangeListener = _b[0], setHasOnAccountChangeListener = _b[1];
    /**
    ...
    var authenticate = react$1.useCallback(function (_a) {
        var _b = _a === void 0 ? {} : _a, onComplete = _b.onComplete, onError = _b.onError, onSuccess = _b.onSuccess, throwOnError = _b.throwOnError, authType = _b.authType;
        return __awaiter(void 0, void 0, void 0, function () {
            var user, error_1;
            return __generator(this, function (_c) {
                switch (_c.label) {
                    ...
                    case 1:
                        _c.trys.push([1, 3, 4, 5]);
                        return [4 /*yield*/, moralis.Moralis.Web3.authenticate(authType ? { type: authType } : undefined)];
                    case 2:
                        user = _c.sent();
                        setUser(user);
                        setAuth({
            ...
            return __generator(this, function (_c) {
                switch (_c.label) {
                    case 0:
                        ...
                        newUser = new moralis.Moralis.User();
                        setMultipleDataToUser(__assign({ username: username,
                            password: password,
                            email: email }, otherFields), newUser);
                        _c.label = 1;
                    case 1:
                        _c.trys.push([1, 3, 4, 5]);
        ...
        return __awaiter(void 0, void 0, void 0, function () {
            ...
            return __generator(this, function (_c) {
                switch (_c.label) {
                    ...
                    case 1:
                        _c.trys.push([1, 3, 4, 5]);
                        return [4 /*yield*/, moralis.Moralis.User.logIn(username, password, {
            ...
            return __generator(this, function (_d) {
                switch (_d.label) {
                    ...
                    case 1:
                        ...
                        return [4 /*yield*/, moralis.Moralis.User.logOut()];
                    case 2:
                        _d.sent();
                    ...
                    case 3:
                        ...
                        setUser((_c = moralis.Moralis.User.current()) !== null && _c !== void 0 ? _c : null);
                        if (throwOnError) {
                            throw error_4;
                        }
                        if (onError) {
    ...
    react$1.useEffect(function () {
        try {
            var currentUser = moralis.Moralis.User.current();
            if (currentUser) {
                setAuth({
                    state: AuthenticationState.AUTHENTICATED,
                    error: null,
...
var _useMoralisInit = function (_a) {
    var appId = _a.appId, serverUrl = _a.serverUrl, jsKey = _a.jsKey, dangerouslyUseOfMasterKey = _a.dangerouslyUseOfMasterKey;
    var _b = react$1.useState(false), isInitialized = _b[0], setIsInitialized = _b[1];
    react$1.useEffect(function () {
        if (!appId || !serverUrl) {
        ...
        moralis.Moralis.initialize(appId, jsKey, dangerouslyUseOfMasterKey);
        moralis.Moralis.serverURL = serverUrl;
        setIsInitialized(true);
    }, [appId, serverUrl, isInitialized]);
    return { isInitialized: isInitialized };
};

var _useMoralisUser = function () {
        ...
        return __awaiter(void 0, void 0, void 0, function () {
            ...
            return __generator(this, function (_c) {
                switch (_c.label) {
                    ...
                    case 2:
                        _c.sent();
                        currentUser = moralis.Moralis.User.current();
                        if (!currentUser) {
 ...
 */
var _useMoralisWeb3 = function (isAuthenticated) {
    var _a = react$1.useState(new moralis.Moralis.Web3()), web3 = _a[0], setWeb3 = _a[1];
            ...
            return __generator(this, function (_c) {
                switch (_c.label) {
                    ...
                    case 1:
                        _c.trys.push([1, 3, 4, 5]);
                        console.log("1");
                        return [4 /*yield*/, moralis.Moralis.Web3.enable()];
                    case 2:
                        currentWeb3 = _c.sent();
...
var MoralisProvider = function (_a) {
    var children = _a.children, appId = _a.appId, jsKey = _a.jsKey, dangerouslyUseOfMasterKey = _a.dangerouslyUseOfMasterKey, serverUrl = _a.serverUrl, _b = _a.options, _c = _b === void 0 ? {} : _b, onAccountChanged = _c.onAccountChanged;
    ...
    var _d = _useMoralisUser(), setUser = _d.setUser, moralisUser = __rest(_d, ["setUser"]);
    var moralisAuth = _useMoralisAuth({ onAccountChanged: onAccountChanged, setUser: setUser });
    var moralisWeb3 = _useMoralisWeb3();
    return (jsxRuntime.jsx(MoralisContext.Provider, __assign({ value: __assign(__assign(__assign(__assign({ Moralis: moralis.Moralis }, moralisInit), moralisAuth), moralisUser), moralisWeb3) }, { children: children }), void 0));
};
...
var _useSafeUpdatedQuery = function (nameOrObject, queryMap, dependencies, isInitialized) {
    ...
    var query = react$1.useMemo(function () {
        var q = new moralis.Moralis.Query(
...
var defaultUseMoralisQueryOptions = {
    autoFetch: true,
    live: false,
    onLiveEnter: function (entity, all) { return __spreadArray(__spreadArray([], all), [entity]); },
    onLiveCreate: function (entity, all) { return __spreadArray(__spreadArray([], all), [entity]); },
...
var useMoralisQuery = function (nameOrObject, queryMap, dependencies, options) {
    ...
    if (options === void 0) { options = {}; }
    var isInitialized = useMoralis().isInitialized;
    var _a = __assign(__assign({}, defaultUseMoralisQueryOptions), options), live = _a.live, autoFetch = _a.autoFetch, onLiveCreate = _a.onLiveCreate, onLiveDelete = _a.onLiveDelete, onLiveEnter = _a.onLiveEnter, onLiveLeave = _a.onLiveLeave, onLiveUpdate = _a.onLiveUpdate;
    var _b = react$1.useState(false), isFetching = _b[0], setIsFetching = _b[1];
    var _c = react$1.useState(null), error = _c[0], setError = _c[1];
    // TODO: change to useReducer or useImmerReducer to avoid misbehaviour on multiple calls
    var _d = i([]), data = _d[0], setData = _d[1];
    var query = _useSafeUpdatedQuery(nameOrObject, queryMap, dependencies, isInitialized);
     ...
     */
    var fetch = react$1.useCallback(function (_a) {
        var _b = _a === void 0 ? {} : _a, onError = _b.onError, onComplete = _b.onComplete, onSuccess = _b.onSuccess, throwOnError = _b.throwOnError;
        return __awaiter(void 0, void 0, void 0, function () {
            var results, error_1;
            return __generator(this, function (_c) {
                switch (_c.label) {
    ...
    var isLoading = isFetching && data == null;
    return { fetch: fetch, isFetching: isFetching, isLoading: isLoading, error: error, data: data !== null && data !== void 0 ? data : [] };
};
        ...
        return __awaiter(void 0, void 0, void 0, function () {
            ...
            return __generator(this, function (_c) {
                switch (_c.label) {
                    ...
                    case 1:
                        _c.trys.push([1, 3, 4, 5]);
                        Object_1 = moralis.Moralis.Object.extend(objectClassName);
...
var PoweredByColour = function (_a) {
    var style = _a.style;
    return (jsxRuntime.jsxs("svg", __assign({ style: style, xmlns: "http://www.w3.org/2000/svg", viewBox: "0 0 192 45" }, { children: [jsxRuntime.jsx("path", { style: { fill: brand }, d: "M0 22.5A21.51 21.51 0 0121.5 1h149a21.5 21.5 0 010 43h-149A21.51 21.51 0 010 22.5z" }, void 0),
            jsxRuntime.jsx("circle", { cx: "25.5", cy: "22.5", r: "17.5" }, void 0),
