            ...
            return __generator(this, function (_c) {
                switch (_c.label) {
                    ...
                    case 1:
                        ...
                        return [4 /*yield*/, Moralis.Cloud.run(name, __assign(__assign({}, params), fetchParams))];
                    case 2:
                        results = _c.sent();
                        setData(results);
                        if (onSuccess) {
...
function i(o){var f=useState(o),i=f[1];return [f[0],useCallback(function(n){i("function"==typeof n?fn(n):n);},[])]}
...
var _useMoralisAuth = function (options) {
    ...
    var _a = useState(initialAuth), auth = _a[0], setAuth = _a[1];
    var _b = useState(false), hasOnAccountChangeListener = _b[0], setHasOnAccountChangeListener = _b[1];
    /**
        ...
        return __awaiter(void 0, void 0, void 0, function () {
            ...
            return __generator(this, function (_c) {
                switch (_c.label) {
                    ...
                    case 1:
                        _c.trys.push([1, 3, 4, 5]);
                        return [4 /*yield*/, Moralis.Web3.authenticate(authType ? { type: authType } : undefined)];
                    case 2:
                        user = _c.sent();
                        setUser(user);
                        setAuth({
            ...
            return __generator(this, function (_c) {
                switch (_c.label) {
                    ...
                    case 1:
                        _c.trys.push([1, 3, 4, 5]);
                        console.log("1");
                        return [4 /*yield*/, Moralis.Web3.enable()];
                    case 2:
                        currentWeb3 = _c.sent();
...
var MoralisProvider = function (_a) {
    ...
    return (jsx(MoralisContext.Provider, __assign({ value: __assign(__assign(__assign(__assign({ Moralis: Moralis }, moralisInit), moralisAuth), moralisUser), moralisWeb3) }, { children: children }), void 0));
};
...
var PoweredByColour = function (_a) {
    var style = _a.style;
    return (jsxs("svg", __assign({ style: style, xmlns: "http://www.w3.org/2000/svg", viewBox: "0 0 192 45" }, { children: [jsx("path", { style: { fill: brand }, d: "M0 22.5A21.51 21.51 0 0121.5 1h149a21.5 21.5 0 010 43h-149A21.51 21.51 0 010 22.5z" }, void 0),
            jsx("circle", { cx: "25.5", cy: "22.5", r: "17.5" }, void 0),
            ...
            jsx("path", { style: { fill: brand }, d: "M34.36 26.89a2.71 2.71 0 00-2.08 1 2.56 2.56 0 00-.57 1.62 2.63 2.63 0 002.65 2.6 2.69 2.69 0 002.11-1l.12-.16a2.6 2.6 0 00-2.23-4z" }, void 0),
...
var PoweredByLight = function (_a) {
    var style = _a.style;
    return (jsxs("svg", __assign({ style: style, xmlns: "http://www.w3.org/2000/svg", viewBox: "0 0 192 45" }, { children: [jsx("path", { style: { fill: white }, d: "M1,22.5A21.51,21.51,0,0,1,22.5,1h147a21.5,21.5,0,0,1,0,43H22.5A21.51,21.51,0,0,1,1,22.5Z" }, void 0),
            jsx("path", { d: "M37.6,30.9h0l-.12.16S37.56,31,37.6,30.9Z" }, void 0),
            ...
            jsx("path", { style: { fill: brand }, d: "M35.36,26.89a2.71,2.71,0,0,0-2.08,1,2.56,2.56,0,0,0-.57,1.62,2.63,2.63,0,0,0,2.65,2.6,2.69,2.69,0,0,0,2.11-1l.12-.16a2.6,2.6,0,0,0-2.23-4Z" }, void 0),
            ...
            jsx("path", { d: "M22.5,2h147V0H22.5Zm147,41H22.5v2h147Zm-147,0A20.5,20.5,0,0,1,2,22.5H0A22.5,22.5,0,0,0,22.5,45ZM190,22.5A20.5,20.5,0,0,1,169.5,43v2A22.5,22.5,0,0,0,192,22.5ZM169.5,2A20.5,20.5,0,0,1,190,22.5h2A22.5,22.5,0,0,0,169.5,0ZM22.5,0A22.5,22.5,0,0,0,0,22.5H2A20.5,20.5,0,0,1,22.5,2Z" }, void 0)] }), void 0));
};
var PoweredByDark = function (_a) {
    var style = _a.style;
    return (jsxs("svg", __assign({ style: style, xmlns: "http://www.w3.org/2000/svg", viewBox: "0 0 192 45" }, { children: [jsx("path", { d: "M1,22.5A21.51,21.51,0,0,1,22.5,1h147a21.5,21.5,0,0,1,0,43H22.5A21.51,21.51,0,0,1,1,22.5Z" }, void 0),
            jsx("path", { style: { fill: white }, d: "M37.6,30.9h0l-.12.16S37.56,31,37.6,30.9Z" }, void 0),
...
export { ByMoralis, MoralisContext, MoralisProvider, NoMoralisContextProviderError, NotAuthenticatedError, ReactMoralisError, ValidationError, useMoralis, useMoralisCloudFunction, useMoralisFile, useMoralisQuery, useMoralisSubscription, useNewMoralisObject };
