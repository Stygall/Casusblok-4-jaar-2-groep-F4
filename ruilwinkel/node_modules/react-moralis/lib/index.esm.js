...
var _useMoralisAuth = function (options) {
    ...
    var authenticate = useCallback(function (_a) {
        var _b = _a === void 0 ? {} : _a, onComplete = _b.onComplete, onError = _b.onError, onSuccess = _b.onSuccess, throwOnError = _b.throwOnError, type = _b.type;
        return __awaiter(void 0, void 0, void 0, function () {
            var user, error_1;
            return __generator(this, function (_c) {
                switch (_c.label) {
                    ...
                    case 1:
                        _c.trys.push([1, 3, 4, 5]);
                        return [4 /*yield*/, Moralis.Web3.authenticate(type ? { type: type } : undefined)];
                    case 2:
                        user = _c.sent();
                        setUser(user);
                        setAuth({
